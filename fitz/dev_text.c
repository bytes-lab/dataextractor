...
#define LINE_DIST 20.0f
#define SPACE_DIST 1.2f
...
static void
fz_add_text_char(fz_text_span **last, float size, int wmode, int c, fz_bbox bbox)
{
	...
	if ((span->size != size || span->wmode != wmode) && c != 32)
	{
